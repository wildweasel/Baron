...
public class ArduinoControl{
	...
	private static final String TAG = ArduinoControl.class.getSimpleName();
	...
	public void sendMessage(byte[] buffer){
		if(usbComms != null){
			String message = "";
			for(byte b : buffer)
				message += String.format("%x ", b);
			Log.e(TAG, "sending drive message: "+message);
			usbComms.sendMessage(buffer);
		}
	}
	
	public boolean isBaronReady(){
		return mAccessory != null && usbComms != null;
	}
